...
const icons: Record<string, ReactNode> = {
  ...
  "Estádios":     <svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path d="M10 2C5.58 2 2 4.24 2 7v1c0 .55.45 1 1 1h2v5H3a1 1 0 00-1 1v2a1 1 0 001 1h14a1 1 0 001-1v-2a1 1 0 00-1-1h-2V9h2c.55 0 1-.45 1-1V7c0-2.76-3.58-5-8-5zM7 9h6v5H7V9z"/><ellipse cx="10" cy="7" rx="6" ry="1.5"/></svg>,
  ...
  "Meus Campeões":<svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path d="M13 3a1 1 0 00-1-1H8a1 1 0 00-1 1v1H4a1 1 0 00-1 1v1a4 4 0 004.5 3.98A4.5 4.5 0 0011 12.5V14H9a2 2 0 00-2 2v1h6v-1a2 2 0 00-2-2h-2v-1.5a4.5 4.5 0 003.5-3.52A4 4 0 0017 6V5a1 1 0 00-1-1h-3V3z"/><path d="M6.5 8.5a1 1 0 01.5.87V9a2 2 0 01-2-2V6h1a2.5 2.5 0 01.5 2.5zM13.5 8.5A2.5 2.5 0 0114 6h1v1a2 2 0 01-2 2v-.63a1 1 0 01.5-.87z"/></svg>,
  ...
  "Artilharia":   <svg viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><circle cx="10" cy="8" r="3"/><path d="M10 11c-3 0-5 1.5-5 4v1h10v-1c0-2.5-2-4-5-4z"/><circle cx="16" cy="6" r="2.5"/><path d="M18.5 4.5L16 6l1.5 1.5"/></svg>,
